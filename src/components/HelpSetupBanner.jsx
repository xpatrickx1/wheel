    ...
    <div className="relative max-w-[92%] xl:max-w-7xl mx-auto px-2 mt-[40px] md:mt-[80px] mb-[80px] md:mb-[107px] ">
      <div className="relative overflow-hidden z-1 w-full rounded-2xl bg-gradient-to-r mr-[4px] from-blue-600 to-blue-500 text-white flex flex-col md:flex-row items-center justify-between px-6 md:px-18 py-7 md:py-14">
        <div className="md:w-2xl space-y-4 z-10">
          <h2 className="text-2xl md:text-4xl font-semibold">{t('helpBannerTitle')}</h2>
          <p className="text-[#F9F9F9] text-md md:text-xl leading-relaxed">
            {t('helpBannerSubtitle')}
          </p>
          <a href="sign-up" className="mt-10 inline-block bg-white text-[#0572EE] whitespace-nowrap  text-md xl:text-lg font-medium px-8 py-5 rounded-lg shadow hover:bg-blue-50 transition">
            {t('tryBtn')}
          </a>
        </div>
        ...
        <img
          src={helpSetup}
          alt="Виджеты"
          className="absolute hidden md:block -top-[37%] transform-translate-y-1/2 max-w-[580px] right-0 z-0 pointer-events-none md:w-[596px]"
        />

      </div>

      <div className="absolute inset-0 z-0 -top-[14px] md:-top-[24px] left-[24px] bottom-[66px] -right-[4px] md:-right-[24px] rounded-2xl pointer-events-none
