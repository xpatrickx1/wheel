...
export const Header: React.FC = () => {
  ...
  const pagesWithButton = ['/pay', '/dashboard', '/partner'];
  const showButton = pagesWithButton.includes(location.pathname);
  ...
  return (
    <header className={`flex items-center box-border max-w-9xl mx-auto justify-between w-full p-5 fixed top-0 z-50 ${
      ...
      <div
          className={`fixed inset-x-0 top-20 z-40 flex flex-col items-center gap-4 bg-black text-white transition-all duration-500 overflow-hidden ${
